...
const ProductList=(props)=>{
	...
	const handleSearchChange = (searchValue) => {
	  ...
	  const paginate = (pageNumber) => {
		...
		if (sortType === "desc") {
		  setCurrentItems(filteredProducts.sort((a, b) => b.price - a.price).slice(indexOfFirstItem, indexOfLastItem));
		} else if (sortType === "asc") {
		  setCurrentItems(filteredProducts.sort((a, b) => a.price - b.price).slice(indexOfFirstItem, indexOfLastItem));
		} else {
               ...
               <HeaderSearch onSearchChange={handleSearchChange}/>
                <div className={"d-flex"}>
					...
					<ul className="grid-tab nav nav-pills" id="list-tab" role="tablist">
					  ...
					  <li className="nav-item " role="presentation">
						<button className="nav-link active" id="pills-grid-tab" data-bs-toggle="pill" data-bs-target="#pills-grid" type="button" role="tab" aria-controls="pills-grid" aria-selected="false">
					  ...
					  <select className="sort" value={sortType} onChange={handleSort}>
