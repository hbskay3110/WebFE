          ...
          <div className="card-footer border-0 pt-2">
            <div className="common d-flex align-items-center justify-content-between">
              ...
              <div
                ...
                onClick={() => handleAddCardClick(props)}
              >
                              ...
                              <td>
                                <div className="media-bx d-flex py-3  align-items-center">
                                  <img
                                    ...
                                    src="images/popular-img/pic-1.jpg"
                                    alt="images"
                                  />
                                  <div>
                            ...
                            <tr>
                              ...
                              <td>
                                <div className="media-bx d-flex py-3  align-items-center">
                                  <img
                                    className="me-3 rounded-circle"
                                    src="images/popular-img/review-img/pic-1.jpg"
                                    alt="images"
                                  />
                                  <div>
                            ...
                            <tr>
                              ...
                              <td>
                                <div className="media-bx d-flex py-3  align-items-center">
                                  <img
                                    className="me-3 rounded-circle"
                                    src="images/popular-img/pic-2.jpg"
                                    alt="images"
                                  />
                                  <div>
                              ...
                              <td>
                                <span className="badge badge-xl light badge-primary">
                                  Delivering
                                </span>
                              </td>
                              <td>
                            ...
                            <tr>
                              ...
                              <td>
                                <div className="media-bx d-flex py-3  align-items-center">
                                  <img
                                    className="me-3 rounded-circle"
                                    src="images/popular-img/review-img/pic-2.jpg"
                                    alt="images"
                                  />
                                  <div>
                            ...
                            <tr className="dlab-table-bottom-line">
                              ...
                              <td>
                                <div className="media-bx d-flex py-3  align-items-center">
                                  <img
                                    className="me-3 rounded-circle"
                                    src="images/popular-img/review-img/pic-3.jpg"
                                    alt="images"
                                  />
                                  <div>
                              ...
                              <td>
                                <span className="badge badge-xl  light badge-danger">
                                  Canceled
                                </span>
                              </td>
                              <td>
